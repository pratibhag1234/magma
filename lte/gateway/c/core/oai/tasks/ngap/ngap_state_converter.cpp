...
void NgapStateConverter::supported_tai_item_to_proto(
  ...
  for (int idx = 0; idx < state_supported_tai_item->bplmnlist_count; idx++) {
    plmn_array[0] =
        (char) (state_supported_tai_item->bplmn_list[idx].plmn_id.mcc_digit1 + ASCII_ZERO);
    plmn_array[1] =
        (char) (state_supported_tai_item->bplmn_list[idx].plmn_id.mcc_digit2 + ASCII_ZERO);
    plmn_array[2] =
        (char) (state_supported_tai_item->bplmn_list[idx].plmn_id.mcc_digit3 + ASCII_ZERO);
    plmn_array[3] =
        (char) (state_supported_tai_item->bplmn_list[idx].plmn_id.mnc_digit1 + ASCII_ZERO);
    plmn_array[4] =
        (char) (state_supported_tai_item->bplmn_list[idx].plmn_id.mnc_digit2 + ASCII_ZERO);
    plmn_array[5] =
        (char) (state_supported_tai_item->bplmn_list[idx].plmn_id.mnc_digit3 + ASCII_ZERO);
